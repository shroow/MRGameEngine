...
namespace shr
{
	...
	void SceneInfo::LoadResourcesInfo()
	{
		...
		//Monsters
		{
			...
			//DemonMage(sheet)
			Resources::Load<Texture>(L"DemonMage_Sheet", L"Monsters\\Demon_mage_creativekind\\Demon_mage-Sheet.png");

			//Necromancer(sheet)
			Resources::Load<Texture>(L"Necromancer_Sheet", L"Monsters\\Necromancer_creativekind-Sheet.png");
		}
